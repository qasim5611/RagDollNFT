...
import { setHomeDocs } from "../../../redux/actions/adminDash_action.js";
...
useEffect(() => {
  ...
  axios.get(API + "/getHomeDocsbyid", { params }).then((res) => {
    console.log("getHomeDocsbyid.data", res.data);
  ...
  const validate = () => {
    ...
    if (
      ...
      setbtnlinkerr();
    } else if (state.btnlink.length == 0) {
      isvalid = false;
      settitleerr("");
      setbtnerr("");
      setbtnlinkerr("Button Link Should Not Empty");
    } else {
      settitleerr("");
      setbtnerr("");
      setbtnlinkerr("");
    ...
    <div class="content-wrapper">
      ...
      >
        <Row className="table-header">
          <Col xs="12" md="12">
            <h2 class="section-title">Enter New Document Detail</h2>
          </Col>
        </Row>
        <div class="row">
          <Row>
                      ...
                      <form key={index}>
                        ...
                        <div class="form-group">
                          ...
                          <input
                            ...
                            required
                            onChange={onChangeHandler}
                            defaultValue={item.btnlink}
                          />
                          <center>
                            {btnlinkerr ? (
                              <div style={errmsg}>{btnlinkerr}</div>
                            ) : null}
                          </center>
                        </div>

                        <div class="form-group">
                          <label for="pwd">Docs Logo/Image 150*150 </label>
                          <input
                            type="file"
                            class="form-control"
                            required
