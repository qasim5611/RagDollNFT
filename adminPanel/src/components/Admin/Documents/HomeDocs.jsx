...
const HomeDocs = () => {
  ...
  useEffect(() => {
    axios.get(API + "/getHomeDocsRefresh").then((result) => {
      console.log("getHomeDocsRefresh");
  ...
  const [head, sethead] = useState(false);
   ...
   useEffect(() => {
     axios.get(API + "/getDocsHeadingRefresh").then((result) => {
       console.log("getDocsHeadingRefresh");
       console.log(result.data);

       sethead(result.data.user);
       //  setArticleList2(result.data.user);
     });
   }, []);
    ...
    <div class="content-wrapper">
      ...
      >
        ...
        <Row className="table-header">
          <Col md="4">
            <h2 class="section-title">Edit All Documents</h2>
          </Col>
          <Col md="8">
            <form class="form-inline form-searchbar" action="#">
              ...
              {/* <NavLink to="/adminDashboard/appsetting/list/home-createDocs">
                <button
                  type="submit"
                    ...
                    {articleList.map((item, ind) => {
                      return (
                        <tr>
                          ...
                          <td>{item.btnlink && item.btnlink}</td>
                          ...
                          <td style={{ textAlign: "center" }}>
                            <Link
                              to={`/adminDashboard/appsetting/list/home-updateDocs/${item._id}`}
                            >
                              <ModeEditIcon />
                            </Link>
      ...
      {/* ////////////////////////////////////////////////////////////////////////////////////////////// */}
      {/* Below For Update Documents Title and Desc */}
        ...
        <Row className="table-header">
          <Col md="4">
            <h2 class="section-title">
              Update Documents Title and Description{" "}
            </h2>
          </Col>
          <Col md="8">
            <form class="form-inline form-searchbar" action="#">
                ...
                <table class="table table-bordered">
                  <tbody>
                    <tr>
                      <th class="active">S#</th>
                      <th class="active">Docs Title</th>
                      <th class="active">Docs Description</th>
                    ...
                    {head.map((item, ind) => {
                      return (
                        <tr>
                          ...
                          <td style={{ textAlign: "center" }}>
                            <Link
                              to={`/adminDashboard/appsetting/list/home-updateDocsDesc/${item._id}`}
                            >
                              <ModeEditIcon />
                            </Link>
                            {/* <Link to={`/admin/magzine_update/${item._id}`}>
